...
router.post("/create", check.auth, ProductTypeController.create);
//4.2.2-Ruta de ver productType:
router.get("/productTypeList/:page?", check.auth, ProductTypeController.productTypeList);
//4.2.3-Ruta de cruta actualizar productType:
router.put('/update', check.auth, ProductTypeController.productTypeUpdate);
